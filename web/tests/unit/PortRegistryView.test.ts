  ...
  loadPortRegistry: vi.fn().mockResolvedValue({
    ...
    facts: [
      ...
      },
      {
        ...
        protocol: 'tcp',
        source: 'process',
        evidence: 'live listener',
        observedAt: '2026-07-16T12:00:00Z',
      },
    ],
    conflicts: [
      { id: 'conflict', type: 'DECLARED_VS_BOUND', port: 18081, summary: 'conflict', facts: [] },
    ],
  }),
  suggestPort: vi.fn().mockResolvedValue({
    port: 18082,
    rangeStart: 15000,
    rangeEnd: 19999,
    protocol: 'tcp',
